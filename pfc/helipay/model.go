...
type AppPayResponse struct {
	...
	Rt22CreditAmount          decimal.Decimal `json:"rt22_creditAmount,omitempty"`       //拓展参数(AccountPayQuery)
	Rt23PaymentAmount         decimal.Decimal `json:"rt23_paymentAmount,omitempty"`      //拓展参数(AccountPayQuery)
	...
	ProductFee                decimal.Decimal `json:"productFee,omitempty"`              //拓展参数(AccountPayQuery)
	ChannelSettlementAmount   decimal.Decimal `json:"channelSettlementAmount,omitempty"` //拓展参数(AccountPayQuery)
	RealCreditAmount          decimal.Decimal `json:"realCreditAmount,omitempty"`        //拓展参数(AccountPayQuery)
	...
	FeeRate                   decimal.Decimal `json:"feeRate,omitempty"`                 //拓展参数(AccountPayQuery)
	FeeAccountAmt             decimal.Decimal `json:"feeAccountAmt,omitempty"`           //拓展参数(AccountPayQuery)
	VoucherDetailList         string          `json:"voucherDetailList"`                 //拓展参数(AccountPayQuery)
	ReceiverFee               decimal.Decimal `json:"receiverFee,omitempty"`             //拓展参数(AccountPayQuery)
	OfflineFee                decimal.Decimal `json:"offlineFee,omitempty"`              //拓展参数(AccountPayQuery)
